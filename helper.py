...
def SaveDate(usrNum, usrName , usrLastName , usrAge , usrGender ,usrHand ,usrType , Catgenerate, Trial , CatNum , Cat ,StimCard , ResCard , PersCat , CorrAns , Acc ,RTime , TstartTime , RstartTime):
    Id = []
    Name = []
    LastName = []
    Age = []
